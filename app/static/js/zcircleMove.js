...
// create by zcy 2016/10/10
	...
	function runCircle(settings){
		...
		R0=parseInt(canvasW/2-lineW0+10);
...
//				console.log(outerColorStart)
//				context.fillStyle = gradient1;
				gradient1.addColorStop(0,outerColorStart);
//				gradient1.addColorStop(1,"white");
				gradient1.addColorStop(0.05,outerColorMid);
...
//				 console.log(loading)
				 var num=loading*7/10
//				  if(num>percent*100){
					   num=percent*7;
//				  };
				 context.fillText(num+"天",canvasW/2-30,canvasH/2)//控制文字百分比的位置
				 context.closePath();
